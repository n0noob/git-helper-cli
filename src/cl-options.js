...
const sections = [
  ...
  },
  {
    header: 'Synopsis',
    content: [
      '$ git-helper-cli {bold --url} {underline url}',
      '$ git-helper-cli {bold --help}'
    ]
  },
  {
    header: 'Options',
    ...
    content: [
      {
        ...
        example: '$ git-helper-cli --url https://github.com/exampleorg/example-repo/tree/master/dir1/dir2/dir3'
      }
    ]
  },
];
